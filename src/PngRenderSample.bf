...
* Ported from https://github.com/ultralight-ux/Ultralight/blob/5011dbfee009074ca5883588fc164b5ba44bf165/samples/Sample%201%20-%20Render%20to%20PNG/main_capi.cpp
*/


namespace UltralightBeefSamples.PngSample
{
	static
	{
		...
		public static void RenderPngSample()
		{
			///
			...
			Debug.WriteLine("Waiting for page to load...");
			...
			Debug.WriteLine("Saved a render of our page to result.png.");
